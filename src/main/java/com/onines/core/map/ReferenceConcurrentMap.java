...
import com.onines.core.lang.func.Func0;
import com.onines.core.util.ObjectUtil;
import com.onines.core.util.ReferenceUtil;
...
public class ReferenceConcurrentMap<K, V> implements ConcurrentMap<K, V>, Iterable<Map.Entry<K, V>>, Serializable {
	...
	public Set<K> keySet() {
		...
		final Collection<K> trans = CollectionUtil.trans(this.raw.keySet(), (reference) -> null == reference ? null : reference.get());
