package com.onines.core.lang;

import com.onines.core.collection.CollectionUtil;
import com.onines.core.map.MapUtil;
import com.onines.core.util.ArrayUtil;
import com.onines.core.util.ObjectUtil;
...
public final class Assert {
     ...
     * @param <X>        异常类型
     * @throws X if expression is false
     */
    ...
    /**
     * 断言对象是否为null，如不为null则抛出指定类型的异常以及错误信息
     *
     * @param obj           待检对象
     * @param errorSupplier 抛出异常附带消息的生产接口
     * @param <X>           异常类型
     * @throws X if obj is not null
     */
    public static <X extends Throwable> void isNull(Object obj, Supplier<? extends X> errorSupplier) throws X {
        if (obj != null) {
            throw errorSupplier.get();
        }
    }
    ...
    /**
     * 断言对象是否为null,如果不为null抛出{@link IllegalArgumentException} 异常
     * <pre class="code">
     *     Assert.isNull(value, "The value must be null");
     *</pre>
     * @param obj 待检对象
     * @param errorMsgTemplate 错误消息模板，占位符使用{}表示
     * @param params 参数列表
     * @throws IllegalArgumentException if obj is not null
     */
    public static void isNull(Object obj,String errorMsgTemplate,Object... params) throws IllegalArgumentException{
        isNull(obj,()->new IllegalArgumentException(StrUtil.format(errorMsgTemplate,params)));
    }
    ...
    public static void isNull(Object obj) throws IllegalArgumentException{
        isNull(obj,"[Assertion failed] -> the obj argument must be null");
    }
     ...
     * </pre>
     * @param obj 待检对象
     * @param supplier 抛出异常附带消息的生产接口
     * @param <T> 待检对象泛型类型
     * @param <X> 异常类型
     * @return 被检查后的对象
     * @throws X if the obj is null
     */
    public static <T,X extends Throwable> T notNull(T obj,Supplier<? extends X> supplier) throws X{
        if (null == obj){
            throw supplier.get();
        }
        return obj;
     ...
     */
    public static <T> T notNull(T obj,String errorMsgTemplate,Object... params) throws IllegalArgumentException{
        return notNull(obj,()->new IllegalArgumentException(StrUtil.format(errorMsgTemplate,params)));
    }
    /**
     ...
     */
    public static <E, T extends Iterator<E>, X extends Throwable> T notEmpty(T collection, Supplier<X> errorSupplier) throws X {
     ...
     */
    public static <E, T extends Iterator<E>> T notEmpty(T collection, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the collection is {@code null} or has no elements
     */
    public static <E, T extends Iterator<E>> T notEmpty(T collection) throws IllegalArgumentException {
